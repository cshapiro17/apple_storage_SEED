...
CO2Sensor ExplorIR;
float readingO2;                                        //O2 reading for EZO2 sensor
float readingCO2;
...
void loop() {                                         //here we go...
  ...
  if(count == 3){                                     //every 5 seconds get another reading
    readingO2 = EZO2.getPercent();
    readingCO2 = ExplorIR.getPercent();
    Serial.print("O2: ");
    Serial.println(readingO2);                          //print reading
    Serial.print("CO2: ");
    Serial.println(readingCO2);                          //print reading    
    count = 0;                                        //reset count
  }
