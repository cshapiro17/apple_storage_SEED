...
// Constructor
Room4::Room4(String roomName, int roomNum, Apple appleType, int o2SolenoidPin, int n2SolenoidPin, int senseSolenoidPin, int o2SolenoidState, int n2SolenoidState, int senseSolenoidState) {
  setRoomName(roomName);
  setRoomNum(roomNum);
	setAppleType(appleType);
  setOxygenSolenoidPin(o2SolenoidPin);
  setNitrogenSolenoidPin(n2SolenoidPin);
  setSensingSolenoidPin(senseSolenoidPin);
  setO2solState(o2SolenoidState);
 ...
 * Returns nothing
 */
void Room4::setRoomName(String roomNameInput) {
