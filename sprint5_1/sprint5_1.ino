...
void setUpSystem() {
  ...
  VRS.setPumpPin(1);                                      // Pin for pump

  // Set up room1 variables
  VRS.rooms[0].setRoomNum(1);                             // Number of room
  VRS.rooms[0].setAppleType(Honeycrisp);                  // Type of apple in room
  VRS.rooms[0].setOxygenSolenoidPin(5);                   // Pin for oxygen solenoid/fan
  VRS.rooms[0].setNitrogenSolenoidPin(8);                 // Pin for nitrogen solenoid
  VRS.rooms[0].setSensingSolenoidPin(11);                 // Pin for the solenoid for measurement in room1
  ...
  VRS.rooms[1].setOxygenSolenoidPin(6);                   // Pin for oxygen solenoid/fan
  VRS.rooms[1].setNitrogenSolenoidPin(9);                 // Pin for nitrogen solenoid
  VRS.rooms[1].setSensingSolenoidPin(12);                 // Pin for the solenoid for measurement in room2
    ...
    case 4:
      ...
      if ((currentMillis - previousMillis) >= delay_interval) {
        ...
        if (VRS.rooms[x].isActive()) {
          ...
          VRS.rooms[x].evaluateRoom(oxygenValue, CO2Value);
